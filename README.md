...
| [baklib-theme-dev](skills/baklib-theme-dev/SKILL.md)                       | `npx skills add baklib-tools/skills --skill baklib-theme-dev`            | **Baklib 站点模板开发**：Liquid 目录与命名、对象/指令/过滤器、静态页 URL、seeds 与 migrations；详规见 **`references/`**                                                                                                                          |
| [baklib-website-cloning](skills/baklib-website-cloning/SKILL.md)           | `npx skills add baklib-tools/skills --skill baklib-website-cloning`       | **参考站复刻工作流**：结构/设计分析、需求与适配、模板分期落地与质检；须确认门；配合 `baklib-theme-dev`                                                                                                                                        |
| [baklib-create-theme](skills/baklib-create-theme/SKILL.md)                 | `npx skills add baklib-tools/skills --skill baklib-create-theme`          | **新建主题脚手架**：`themes/[scope]/[name]/` 目录树与最小可运行文件（settings、layout、templates、locales、Tailwind 等）；语法细则见 `baklib-theme-dev`                                                                                         |
