...
| [bke-markdown-authoring](skills/bke-markdown-authoring/SKILL.md)           | `npx ctx7 skills install /baklib-tools/skills bke-markdown-authoring`     | Baklib **BKE Markdown** 撰写与导入（L1/L2、`dam-id`、文件卡片冒号语法、链接卡片、片段/分栏/嵌入等）；可配合 MCP 解析 DAM 编号                                                                                                                                 |
