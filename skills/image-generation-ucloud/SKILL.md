...
- **不包含**：替代用户执行扣费请求、保证 SLA；亦不重复 **提示词写法**（见 [nano-banana-pro-prompting](https://github.com/baklib-tools/skills/blob/main/skills/nano-banana-pro-prompting/SKILL.md)）。
...
- 总览与工作流：**[image-generation](https://github.com/baklib-tools/skills/blob/main/skills/image-generation/SKILL.md)**。
- 若 UCloud 不可用或需使用 OpenRouter 路由的 Gemini 图像能力：**[image-generation-openrouter](https://github.com/baklib-tools/skills/blob/main/skills/image-generation-openrouter/SKILL.md)**。
