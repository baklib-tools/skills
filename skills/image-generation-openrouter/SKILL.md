...
- **不包含**：替代用户付费、保证模型可用性；亦不重复 **提示词工程**（见 [nano-banana-pro-prompting](https://github.com/baklib-tools/skills/blob/main/skills/nano-banana-pro-prompting/SKILL.md)）。
...
- 总览：**[image-generation](https://github.com/baklib-tools/skills/blob/main/skills/image-generation/SKILL.md)**。
- UCloud ModelVerse 直连：**[image-generation-ucloud](https://github.com/baklib-tools/skills/blob/main/skills/image-generation-ucloud/SKILL.md)**。
